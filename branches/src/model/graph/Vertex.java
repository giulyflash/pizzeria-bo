 ...
 * Wierzcholek jest przedstawiony jako punkt oraz krawêdzie z niego wychodz¹ce.
 * @version 1.1
 */
public class Vertex{
	private int number;	//numer porzadkowy wierzcholka.
	private Point2D.Double coordinate;	//wspolrzedne wierzcholka
	private List<Edge> edges = new ArrayList<Edge>();	//lista krawêdzi wychodzacych z wierzcholka
